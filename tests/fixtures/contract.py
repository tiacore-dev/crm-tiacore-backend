...
async def seed_contract(
    seed_legal_entity, seed_legal_entity_buyer, seed_contract_status, seed_company
):
    ...
    status = await ContractStatus.get_or_none(
        contract_status_id=seed_contract_status["contract_status_id"]
    )
